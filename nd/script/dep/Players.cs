$WW::Exec::DepPlayers = true;

$WW::Players::DefaultShapeNameColor = "1 1 1 1";
...
function Player::removeItem(%this,%item) //Slicksliver555's doing.
{
...
//	}
	...
	{	
		...
		if($WW::Mini.gameRunning && !%this.WW_CURRnotPlaying)
		{
			%dead = $WW::Mini.curGame.Death(%this, (isObject(%killerClient.player) ? %killerClient.player : -1));
			parent::onDeath(%this, %killer, %killerClient, %type, %loc);
			if(%dead)
			{
...
//	}
	...
	function GameConnection::spawnPlayer(%this)
	{
		...
		if(%this.WW_ShapeNameColor !$= "")
			%this.player.setShapeNameColor(%this.WW_ShapeNameColor);
		else
			%this.player.setShapeNameColor($WW::Player::DefaultShapeNameColor);
